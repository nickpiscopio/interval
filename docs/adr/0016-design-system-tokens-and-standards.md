...
We decided to establish a comprehensive, single-source-of-truth design system covering color tokens, typography scales, spacing aliases, and surface semantics.
...
2. **Spacing & Layout**:
   ...
   - **Radii**: `radius.sm: 8` (inputs/buttons), `radius.md: 16` (cards/panels), `radius.full: 9999` (circular pills).
