...
2. **Visual Feedback**:
   - Items in an active drag state exhibit elevated z-index, enhanced drop shadow, and subtle surface highlight (`#F9FAFB`) without scale expansion or brand border tints.
